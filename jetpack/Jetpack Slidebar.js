...
jetpack.slideBar.append({
  ...
  // This automagically becomes our slidebar content.
    ...
    <body>
      <div id="logo"><a>-</a></div>
      <div id="newLineButton">Create new timeline<textarea id="title" onclick="javascript:this.value='';" rows="1">Enter title here</textarea></div>
	  
	  <div id="lineList">
			<div>
				<h1 class="linkTitle">Lines containing this link </h1>
				<div>
					<h2>Web Censorship Matters</h2>
					<table>
						<tr>
						<td>Google / Scientology</td>
						<td class="current">Iran / Youtube</td>
						<td> China / Google</td>
						</tr>
					</table>
					<div>
						<span style="float:right"><b>Next</b></span>
						<span style="float:left"><b>Previous</b></span>					
					</div>
				</div>
			</div>
			<div class="moreLines">4 More...</div>
	  </div>
