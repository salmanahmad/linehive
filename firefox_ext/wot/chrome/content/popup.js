...
const WOT_POPUP_LAYER =
	"<div id=\"wot-logo\"></div>" +
	"HELLOLELKJLDKJFLDSKJ<div id=\"wot-ratings-ID\" class=\"wot-ratings\">" +
		"<div id=\"wot-r0-stack-ID\" class=\"wot-stack\">" +
			"<div id=\"wot-r0-header-ID\" class=\"wot-header\">HELLO</div>" +
			"<div id=\"wot-r0-rep-ID\" class=\"wot-rep\"></div>" +
			"<div id=\"wot-r0-cnf-ID\" class=\"wot-cnf\"></div>" +
		"</div>" +
		"<div id=\"wot-r1-stack-ID\" class=\"wot-stack\">" +
			"<div id=\"wot-r1-header-ID\" class=\"wot-header\">HELLO2</div>" +
